# Разбор блока уверенности

Тест на блок уверенности: корень неверия в себя, связь с детством, число судьбы и 30-дневный план прокачки. Тип блока — бесплатно.
...
- Return URL: `https://self-belief-test.vercel.app/thank-you`
- Webhook URL: `https://self-belief-test.vercel.app/api/webhook` — события `payment.succeeded` и `payment.canceled`
